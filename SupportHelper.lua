...
local var_0_68 = {
    ...
    "Patriot | S | Auction S îò 20.000.000$ | 87 m/h | 120000",
    "Stretch | S | Auction S îò 20.000.000$ | 88 m/h | 120000",
    "Romero | S | Auction S îò 20.000.000$ | 77 m/h | 120000",
    "Burrito | S | Auction S îò 20.000.000$ | 87 m/h | 120000",
    "Caddy | S | Auction S îò 20.000.000$ | 87 m/h | 120000",
    "Camper | S | Auction S îò 20.000.000$ | 68 m/h | 120000",
    "Mesa | S | Auction S îò 20.000.000$ | 78 m/h | 120000",
    "Pizzaboy | S | Auction S îò 20.000.000$ | 62 m/h | 120000",
    "Bloodring Banger | S | Auction S îò 20.000.000$ | 96 m/h | 120000",
    "BMX | S | Auction S îò 20.000.000$ | 40/54 m/h | 120000",
    "Bike | S | Auction S îò 20.000.000$ | 44/58 m/h | 120000",
    "Mountain Bike | S | Auction S îò 20.000.000$ | 56/72 m/h | 120000",
    "Vortex | S | Auction S îò 20.000.000$ | 55 m/h | 120000",
    "Bandito | S | Auction S îò 20.000.000$ | 81 m/h | 120000",
    "Kart | S | Auction S îò 20.000.000$ | 52 m/h | 120000",
    "Dune | S | Auction S îò 20.000.000$ | 61 m/h | 120000",
    "Mower | S | Auction S îò 20.000.000$ | 33 m/h | 120000",
    ...
    "Tesla Model S | L | Hå ïðîäàåòñÿ | 129 m/h",
    ...
    "Bentley Flying Spur | L | Hå ïðîäàåòñÿ | 141 m/h",
    "Tesla Cybertruck | L | Hå ïðîäàåòñÿ | 131 m/h",
...
local var_0_69 = {
	...
	"Ìýðèÿ | /gps 0 10",
	"Àâòîøêîëà | /gps 0 11",
	"Àâèàøêîëà [LV] | /gps 0 12",
	"Àâòîâîêçàë (Ñïàâí íîâè÷êîâ) | /gps 0 13,15,16",
	"Fort Carson | /gps 0 17",
	"Ïðèåì ìåòàëëà | /gps 0 18",
	"Àýðîïîðò [LS] | /gps 0 19",
	"Àýðîïîðò [SF] | /gps 0 20",
	"Àýðîïîðò [LV] | /gps 0 21",
	"Ïëÿæ Santa Maria | /gps 0 24",
	"Ñïîðòçàë [LS] | /gps 0 26",
	"Ñïîðòçàë [SF] | /gps 0 27",
	"Ñïîðòçàë [LV] | /gps 0 28",
	"Ðàçâëåêàòåëüíûå öåíòðû | /gps 0 29-31",
	"Öåðêîâü | /gps 0 32",
	"Âîåíêîìàò ÑÔ | /gps 0 33",
	"Âîåíêîìàò ËÂ | /gps 0 34",
	"Òîðãîâàÿ ïëîùàäêà | /gps 0 35",
	"×åðíûé ðûíîê | /gps 0 36",
	"Êëàäáèùå | /gps 0 37",
	"Òðåíèíã öåíòð | /gps 0 38",
	"Âîåííûé ìóçåé | /gps 0 39",
	"Ñóä | /gps 0 40",
	"Ðûáîëîâíûé ìàãàçèí [Whetstone] | /gps 0 42",
	"Ðûáîëîâíûé ìàãàçèí [Bone] | /gps 0 43",
	"Ñêëàä ñ àëêîãîëåì | /gps 1 0",
	"Íåôòåçàâîä | /gps 1 1",
	"Ñêëàä ïðîäóêòîâ | /gps 1 2",
	"Ñêëàä äëÿ óðîæàÿ ñ ôåðì | /gps 1 3",
	"Ñòîÿíêà ìàøèí Õîò äîãîâ | /gps 1 4",
	"Ñòîÿíêà Èíêàññàòîðîâ | /gps 1 5",
	"Ðàáîòà ãðóç÷èêà | /gps 1 6",
	"Ñêëàä ñ íàðêîòèêàìè | /gps 1 7",
	"Ñòîÿíêà ãðàáèòåëåé ËÝÏ | /gps 1 9",
	"Ñòîÿíêà ýëåêòðèêîâ | /gps 1 10",
	"Îãðàáëåíèå äîìîâ | /gps 1 11",
	"Îðóæåéíûé çàâîä | /gps 1 12",
	"Ïðîäàæà øêóð æèâîòíûõ | /gps 1 13",
	"Ñêëàä ËÑ/ÑÔ/ËÂ | /gps 1 14-16",
	"Àâòîáóñíûé ïàðê [LS] | /gps 1 17",
	"Àâòîáóñíûé ïàðê [SF] | /gps 1 18",
	"Àâòîáóñíûé ïàðê [LV] | /gps 1 19",
	"Àâòîáóñíûå ïàðêè | /gps 1 17-19",
	"Àâòîóãîí [LS] | /gps 1 20",
	"Àâòîóãîí [SF] | /gps 1 21",
	"Àâòîóãîí [LV] | /gps 1 22",
	"Àâòîóãîí âñå ìåñòà | /gps 1 20-22",
	"Ñóìêà äëÿ îãðàáëåíèÿ áàíêà | /gps 1 23-26",
	"Àâòîñàëîí: Nope | /gps 3 0",
	"Àâòîñàëîí: D and C | /gps 3 1",
	"Àâòîñàëîí: L | /gps 3 2",
	"Àóêöèîí àâòî: S | /gps 3 3",
	"Àâòîñàëîí: B and A | /gps 3 4",
	"Ìàãàçèí îäåæäû [LS] | /gps 3 5",
	"Ìàãàçèí îäåæäû [SF] | /gps 3 6",
	"Ìàãàçèí îäåæäû [LV] | /gps 3 7",
	"Ìàãàçèí àêñåññóàðîâ [SF] | /gps 3 8",
	"Ìàãàçèí îðóæèÿ | /gps 3 9-19",
	"Àðåíäà âåðòîëåòà [LS] | /gps 3 20",
	"Àðåíäà âåðòîëåòà [SF] | /gps 3 21",
	"Àðåíäà âåðòîëåòà [LV] | /gps 3 22",
	"Àðåíäà âåðòîëåòà [LS/SF/LV] | /gps 3 20-22",
	"Àðåíäà ñàìîëåòà [LV] | /gps 3 23",
	"Ïîêóïêà âîäíîãî òðàíñïîðòà | /gps 3 24",
	"Ïðèòîíû | /gps 3 25-29",
	"Ôåðìû | /gps 5",
	"Äàëüíîáîéùèêè | /gps 6",
	"ÑÒÎ | /gps 11",
	"Ãàðàæè | /gps 12",
	"Îôèñû | /gps 13",
	"Êàçèíî Four Dragons è Caligula íàõîäÿòñÿ ðÿäîì ñ ýòèì áàðîì | /gps 2 14",
	"Äëÿ îôèñîâ | /gps 14"
}
local var_0_70 = {
	"Áàíêè",
	...
	"Âîåííûé ìóçåé",
	"Ñóä",
	"Ðûáîëîâíûé ìàãàçèí [Whetstone]",
	"Ðûáîëîâíûé ìàãàçèí [Bone]",
	"Ñêëàä ñ àëêîãîëåì",
	"Íåôòåçàâîä",
	"Ñêëàä ïðîäóêòîâ",
	"Ñêëàä äëÿ óðîæàÿ ñ ôåðì",
	"Ñòîÿíêà ìàøèí Õîò äîãîâ",
	"Ñòîÿíêà Èíêàññàòîðîâ",
	"Ðàáîòà ãðóç÷èêà",
	"Ñêëàä ñ íàðêîòèêàìè",
	"Ñòîÿíêà ãðàáèòåëåé ËÝÏ",
	"Ñòîÿíêà ýëåêòðèêîâ",
	"Îãðàáëåíèå äîìîâ",
	"Îðóæåéíûé çàâîä",
	"Ïðîäàæà øêóð æèâîòíûõ",
	"Ñêëàä ËÑ/ÑÔ/ËÂ",
	"Àâòîáóñíûé ïàðê [LS]",
	"Àâòîáóñíûé ïàðê [SF]",
	"Àâòîáóñíûé ïàðê [LV]",
	...
	"Ìàãàçèí îäåæäû [SF] ",
	"Ìàãàçèí îäåæäû [LV] ",
	"Ìàãàçèí àêñåññóàðîâ [SF]",
	"Ìàãàçèí îðóæèÿ",
	"Àðåíäà âåðòîëåòà [LS]",
	"Àðåíäà âåðòîëåòà [SF]",
	"Àðåíäà âåðòîëåòà [LV]",
	"Àðåíäà âåðòîëåòà [LS/SF/LV]",
	"Àðåíäà ñàìîëåòà",
	"Ïîêóïêà âîäíîãî òðàíñïîðòà",
	"Ïðèòîíû",
	"Ôåðìû",
	"Äàëüíîáîéùèêè",
	"ÑÒÎ",
    ...
    lua_thread.create(function()
        ...
        if file then
            ...
            if data.version ~= script_version then
                ...
                sampAddChatMessage(
                    "[Support Helper] Íàéäåíî îáíîâëåíèå!",
                    -1
                )
                ...
                sampAddChatMessage(
                    "[Support Helper] Ñêðèïò îáíîâëåí! Ïåðåçàïóñòèòå èãðó.",
                    -1
                )
                ...
                sampAddChatMessage(
                    "[Support Helper] Ïîñëåäíÿÿ âåðñèÿ.",
                    -1
                )
            end
        end
...
function main()
	...
	if var_6_2 == "Etienne_Kavinsky" or var_6_2 == "Ratnik_Cybersport" or var_6_2 == "Dardas_Beretta" or var_6_2 == "William_Adomson" then
		sampAddChatMessage(var_0_13 .. " {FF0000}Âíèìàíèå! [ {FFFFFF}Âàì îãðàíè÷åí äîñòóï ê äàííîìó ñêðèïòó{FF0000} ]", 16776960)
		sampAddChatMessage(var_0_13 .. " {FF0000}Âíèìàíèå! [ {FFFFFF}Äëÿ ïîëó÷åíèÿ äîñòóïà ê ñêðèïòó ñâÿæèòåñü ñ ðàçðàáîò÷èêîì ñêðèïòà{FF0000} ]", 16776960)
		thisScript():unload()
	else
		sampAddChatMessage("{EEE8AA}---------- Support Helper for Samp-RP ----------", -1)
sampAddChatMessage("{FFFFFF}Ñòàòóñ: {00FF00}Àêòèâèðîâàí", -1)
sampAddChatMessage("{FFFFFF}Ìåíþ: {FFE4B5}/shelper", -1)
sampAddChatMessage("{FFFFFF}Dev: {008000}Garfushaaaaaaaaa", -1)
			...
			if var_8_1 == "35" or var_8_1 == "36" or var_8_1 == "37" or var_8_1 == "78" or var_8_1 == "79" or var_8_1 == "95" or var_8_1 == "134" or var_8_1 == "136" or var_8_1 == "137" or var_8_1 == "212" or var_8_1 == "230" or var_8_1 == "90" or var_8_1 == "193" or var_8_1 == "55" or var_8_1 == "75" or var_8_1 == "77" or var_8_1 == "200" or var_8_1 == "135" or var_8_1 == "96" or var_8_1 == "155" or var_8_1 == "160" or var_8_1 == "25" or var_8_1 == "26" or var_8_1 == "58" or var_8_1 == "143" or var_8_1 == "235" or var_8_1 == "202" or var_8_1 == "13" or var_8_1 == "53" or var_8_1 == "199" or var_8_1 == "73" or var_8_1 == "44" or var_8_1 == "43" or var_8_1 == "14" or var_8_1 == "142" or var_8_1 == "210" or var_8_1 == "24" or var_8_1 == "63" or var_8_1 == "64" or var_8_1 == "197" or var_8_1 == "207" or var_8_1 == "243" or var_8_1 == "60" or var_8_1 == "8" or var_8_1 == "184" or var_8_1 == "2" or var_8_1 == "182" or var_8_1 == "234" or var_8_1 == "88" or var_8_1 == "151" or var_8_1 == "218" or var_8_1 == "231" or var_8_1 == "6" or var_8_1 == "179" or var_8_1 == "67" or var_8_1 == "23" or var_8_1 == "32" or var_8_1 == "128" or var_8_1 == "9" or var_8_1 == "225" or var_8_1 == "183" or var_8_1 == "241" or var_8_1 == "30" or var_8_1 == "22" or var_8_1 == "7" or var_8_1 == "33" or var_8_1 == "40" or var_8_1 == "245" or var_8_1 == "154" or var_8_1 == "84" or var_8_1 == "185" or var_8_1 == "166" or var_8_1 == "291" or var_8_1 == "255" or var_8_1 == "21" or var_8_1 == "42" or var_8_1 == "25" or var_8_1 == "188" or var_8_1 == "238" or var_8_1 == "192" or var_8_1 == "215" or var_8_1 == "20" or var_8_1 == "28" or var_8_1 == "29" or var_8_1 == "142" or var_8_1 == "19" or var_8_1 == "177" or var_8_1 == "176" or var_8_1 == "180" or var_8_1 == "47" or var_8_1 == "48" or var_8_1 == "97" or var_8_1 == "4" or var_8_1 == "82" or var_8_1 == "250" or var_8_1 == "242" or var_8_1 == "227" or var_8_1 == "228" or var_8_1 == "121" or var_8_1 == "247" or var_8_1 == "117" or var_8_1 == "258" or var_8_1 == "259" or var_8_1 == "18" or var_8_1 == "45" or var_8_1 == "249" or var_8_1 == "83" or var_8_1 == "273" or var_8_1 == "123" or var_8_1 == "111" or var_8_1 == "124" or var_8_1 == "170" or var_8_1 == "12" or var_8_1 == "93" or var_8_1 == "172" or var_8_1 == "211" or var_8_1 == "224" or var_8_1 == "251" or var_8_1 == "233" or var_8_1 == "299" or var_8_1 == "119" or var_8_1 == "292" or var_8_1 == "293" or var_8_1 == "297" or var_8_1 == "296" or var_8_1 == "3" or var_8_1 == "289" or var_8_1 == "127" or var_8_1 == "118" or var_8_1 == "112" or var_8_1 == "152" or var_8_1 == "216" or var_8_1 == "219" or var_8_1 == "298" or var_8_1 == "61" or var_8_1 == "5" or var_8_1 == "126" or var_8_1 == "290" or var_8_1 == "248" or var_8_1 == "223" or var_8_1 == "144" or var_8_1 == "208" or var_8_1 == "272" or var_8_1 == "261" or var_8_1 == "190" or var_8_1 == "237" or var_8_1 == "148" or var_8_1 == "263" or var_8_1 == "294" or var_8_1 == "295" or var_8_1 == "100" or var_8_1 == "46" or var_8_1 == "113" or var_8_1 == "125" or var_8_1 == "76" or var_8_1 == "91" or var_8_1 == "141" or var_8_1 == "150" or var_8_1 == "169" or var_8_1 == "214" or var_8_1 == "51" or var_8_1 == "52" or var_8_1 == "72" or var_8_1 == "94" or var_8_1 == "133" or var_8_1 == "206" or var_8_1 == "262" or var_8_1 == "85" or var_8_1 == "87" or var_8_1 == "138" or var_8_1 == "139" or var_8_1 == "244" or var_8_1 == "257" or var_8_1 == "256" then
				if var_8_1 == "35" or var_8_1 == "36" or var_8_1 == "37" or var_8_1 == "78" or var_8_1 == "79" or var_8_1 == "95" or var_8_1 == "134" or var_8_1 == "136" or var_8_1 == "137" or var_8_1 == "212" or var_8_1 == "230" or var_8_1 == "90" or var_8_1 == "193" or var_8_1 == "55" or var_8_1 == "75" or var_8_1 == "77" then
					if var_8_1 == "35" or var_8_1 == "36" or var_8_1 == "37" or var_8_1 == "78" or var_8_1 == "79" or var_8_1 == "95" or var_8_1 == "134" or var_8_1 == "136" or var_8_1 == "137" or var_8_1 == "212" or var_8_1 == "230" then
						lua_thread.create(function()
							local var_9_0 = "Skin 35 | M | 1.000(700 ïðè /boostinfo)"
							local var_9_1, var_9_2, var_9_3 = string.match(var_9_0, "Skin (.+) | (.+) | (.+)")
							local var_9_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_9_3)
					...
					elseif var_8_1 == "90" or var_8_1 == "193" or var_8_1 == "55" or var_8_1 == "75" or var_8_1 == "77" then
						lua_thread.create(function()
							local var_10_0 = "Skin 35 | M | 1.000(700 ïðè /boostinfo)"
							local var_10_1, var_10_2, var_10_3 = string.match(var_10_0, "Skin (.+) | (.+) | (.+)")
							local var_10_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_10_3)
				...
				elseif var_8_1 == "200" or var_8_1 == "135" or var_8_1 == "96" or var_8_1 == "155" or var_8_1 == "160" or var_8_1 == "25" or var_8_1 == "26" or var_8_1 == "58" or var_8_1 == "143" or var_8_1 == "235" or var_8_1 == "202" or var_8_1 == "13" or var_8_1 == "53" or var_8_1 == "199" then
					if var_8_1 == "200" or var_8_1 == "135" or var_8_1 == "96" or var_8_1 == "155" or var_8_1 == "160" or var_8_1 == "25" or var_8_1 == "26" or var_8_1 == "58" or var_8_1 == "143" or var_8_1 == "235" or var_8_1 == "202" then
						lua_thread.create(function()
							local var_11_0 = "Skin 200 | M | 10.000(7.000 ïðè /boostinfo)"
							local var_11_1, var_11_2, var_11_3 = string.match(var_11_0, "Skin (.+) | (.+) | (.+)")
							local var_11_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_11_3)
					...
					elseif var_8_1 == "13" or var_8_1 == "53" or var_8_1 == "199" then
						lua_thread.create(function()
							local var_12_0 = "Skin 200 | M | 10.000(7.000 ïðè /boostinfo)"
							local var_12_1, var_12_2, var_12_3 = string.match(var_12_0, "Skin (.+) | (.+) | (.+)")
							local var_12_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_12_3)
				...
				elseif var_8_1 == "73" or var_8_1 == "44" or var_8_1 == "43" or var_8_1 == "14" or var_8_1 == "142" or var_8_1 == "210" or var_8_1 == "24" or var_8_1 == "63" or var_8_1 == "64" or var_8_1 == "197" or var_8_1 == "207" or var_8_1 == "243" then
					if var_8_1 == "73" or var_8_1 == "44" or var_8_1 == "43" or var_8_1 == "14" or var_8_1 == "142" or var_8_1 == "210" or var_8_1 == "24" then
						lua_thread.create(function()
							local var_13_0 = "Skin 63 | Æ | 50.000(35.000 ïðè /boostinfo)"
							local var_13_1, var_13_2, var_13_3 = string.match(var_13_0, "Skin (.+) | (.+) | (.+)")
							local var_13_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_13_3)
					...
					elseif var_8_1 == "63" or var_8_1 == "64" or var_8_1 == "197" or var_8_1 == "207" or var_8_1 == "243" then
						lua_thread.create(function()
							local var_14_0 = "Skin 63 | Æ | 50.000(35.000 ïðè /boostinfo)"
							local var_14_1, var_14_2, var_14_3 = string.match(var_14_0, "Skin (.+) | (.+) | (.+)")
							local var_14_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_14_3)
				...
				elseif var_8_1 == "60" or var_8_1 == "8" or var_8_1 == "184" or var_8_1 == "2" or var_8_1 == "182" or var_8_1 == "234" or var_8_1 == "88" or var_8_1 == "151" or var_8_1 == "218" or var_8_1 == "231" then
					if var_8_1 == "60" or var_8_1 == "8" or var_8_1 == "184" or var_8_1 == "2" or var_8_1 == "182" or var_8_1 == "234" then
						lua_thread.create(function()
							local var_15_0 = "Skin 88 | Æ | 100.000(70.000 ïðè /boostinfo)"
							local var_15_1, var_15_2, var_15_3 = string.match(var_15_0, "Skin (.+) | (.+) | (.+)")
							local var_15_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_15_3)
					...
					elseif var_8_1 == "88" or var_8_1 == "151" or var_8_1 == "218" or var_8_1 == "231" then
						lua_thread.create(function()
							local var_16_0 = "Skin 88 | Æ | 100.000(70.000 ïðè /boostinfo)"
							local var_16_1, var_16_2, var_16_3 = string.match(var_16_0, "Skin (.+) | (.+) | (.+)")
							local var_16_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_16_3)
				...
				elseif var_8_1 == "6" or var_8_1 == "179" or var_8_1 == "67" or var_8_1 == "23" or var_8_1 == "32" or var_8_1 == "128" or var_8_1 == "9" or var_8_1 == "225" then
					if var_8_1 == "6" or var_8_1 == "179" or var_8_1 == "67" or var_8_1 == "23" or var_8_1 == "32" or var_8_1 == "128" then
						lua_thread.create(function()
							local var_17_0 = "Skin 9 | Æ | 250.000(175.000 ïðè /boostinfo)"
							local var_17_1, var_17_2, var_17_3 = string.match(var_17_0, "Skin (.+) | (.+) | (.+)")
							local var_17_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_17_3)
					...
					elseif var_8_1 == "9" or var_8_1 == "225" then
						lua_thread.create(function()
							local var_18_0 = "Skin 9 | Æ | 250.000(175.000 ïðè /boostinfo)"
							local var_18_1, var_18_2, var_18_3 = string.match(var_18_0, "Skin (.+) | (.+) | (.+)")
							local var_18_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_18_3)
				...
				elseif var_8_1 == "183" or var_8_1 == "241" or var_8_1 == "30" or var_8_1 == "22" or var_8_1 == "7" or var_8_1 == "33" or var_8_1 == "40" or var_8_1 == "245" then
					if var_8_1 == "183" or var_8_1 == "241" or var_8_1 == "30" or var_8_1 == "22" or var_8_1 == "7" or var_8_1 == "33" then
						lua_thread.create(function()
							local var_19_0 = "Skin 40 | Æ | 500.000(350.000 ïðè /boostinfo)"
							local var_19_1, var_19_2, var_19_3 = string.match(var_19_0, "Skin (.+) | (.+) | (.+)")
							local var_19_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_19_3)
					...
					elseif var_8_1 == "40" or var_8_1 == "245" then
						lua_thread.create(function()
							local var_20_0 = "Skin 40 | Æ | 500.000(350.000 ïðè /boostinfo)"
							local var_20_1, var_20_2, var_20_3 = string.match(var_20_0, "Skin (.+) | (.+) | (.+)")
							local var_20_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_20_3)
				...
				elseif var_8_1 == "154" or var_8_1 == "84" or var_8_1 == "185" or var_8_1 == "166" or var_8_1 == "291" or var_8_1 == "255" or var_8_1 == "21" or var_8_1 == "42" or var_8_1 == "25" or var_8_1 == "188" or var_8_1 == "238" or var_8_1 == "192" or var_8_1 == "215" then
					if var_8_1 == "154" or var_8_1 == "84" or var_8_1 == "185" or var_8_1 == "166" or var_8_1 == "291" or var_8_1 == "255" or var_8_1 == "21" or var_8_1 == "42" or var_8_1 == "25" or var_8_1 == "188" then
						lua_thread.create(function()
							local var_21_0 = "Skin 238 | Æ | 1.000.000(700.000 ïðè /boostinfo)"
							local var_21_1, var_21_2, var_21_3 = string.match(var_21_0, "Skin (.+) | (.+) | (.+)")
							local var_21_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_21_3)
					...
					elseif var_8_1 == "238" or var_8_1 == "192" or var_8_1 == "215" then
						lua_thread.create(function()
							local var_22_0 = "Skin 238 | Æ | 1.000.000(700.000 ïðè /boostinfo)"
							local var_22_1, var_22_2, var_22_3 = string.match(var_22_0, "Skin (.+) | (.+) | (.+)")
							local var_22_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_22_3)
				...
				elseif var_8_1 == "20" or var_8_1 == "28" or var_8_1 == "29" or var_8_1 == "142" or var_8_1 == "19" or var_8_1 == "177" or var_8_1 == "176" or var_8_1 == "180" or var_8_1 == "47" or var_8_1 == "48" or var_8_1 == "97" or var_8_1 == "4" or var_8_1 == "82" or var_8_1 == "250" or var_8_1 == "242" or var_8_1 == "227" or var_8_1 == "228" or var_8_1 == "121" or var_8_1 == "247" or var_8_1 == "117" or var_8_1 == "258" or var_8_1 == "259" or var_8_1 == "18" or var_8_1 == "45" or var_8_1 == "249" or var_8_1 == "83" or var_8_1 == "273" or var_8_1 == "123" or var_8_1 == "111" or var_8_1 == "124" or var_8_1 == "170" or var_8_1 == "12" or var_8_1 == "93" or var_8_1 == "172" or var_8_1 == "211" or var_8_1 == "224" or var_8_1 == "251" or var_8_1 == "233" then
					if var_8_1 == "20" or var_8_1 == "28" or var_8_1 == "29" or var_8_1 == "142" or var_8_1 == "19" or var_8_1 == "177" or var_8_1 == "176" or var_8_1 == "180" or var_8_1 == "47" or var_8_1 == "48" or var_8_1 == "97" or var_8_1 == "4" or var_8_1 == "82" or var_8_1 == "250" or var_8_1 == "242" or var_8_1 == "227" or var_8_1 == "228" or var_8_1 == "121" or var_8_1 == "247" or var_8_1 == "117" or var_8_1 == "258" or var_8_1 == "259" or var_8_1 == "18" or var_8_1 == "45" or var_8_1 == "249" or var_8_1 == "83" or var_8_1 == "273" or var_8_1 == "123" or var_8_1 == "111" or var_8_1 == "124" or var_8_1 == "170" then
						lua_thread.create(function()
							local var_23_0 = "Skin 20 | M | 2.000.000(1.400.000 ïðè /boostinfo)"
							local var_23_1, var_23_2, var_23_3 = string.match(var_23_0, "Skin (.+) | (.+) | (.+)")
							local var_23_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_23_3)
					...
					elseif var_8_1 == "12" or var_8_1 == "93" or var_8_1 == "172" or var_8_1 == "211" or var_8_1 == "224" or var_8_1 == "251" or var_8_1 == "233" then
						lua_thread.create(function()
							local var_24_0 = "Skin 20 | M | 2.000.000(1.400.000 ïðè /boostinfo)"
							local var_24_1, var_24_2, var_24_3 = string.match(var_24_0, "Skin (.+) | (.+) | (.+)")
							local var_24_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_24_3)
				...
				elseif var_8_1 == "299" or var_8_1 == "119" or var_8_1 == "292" or var_8_1 == "293" or var_8_1 == "297" or var_8_1 == "296" or var_8_1 == "3" or var_8_1 == "289" or var_8_1 == "127" or var_8_1 == "118" or var_8_1 == "112" or var_8_1 == "152" or var_8_1 == "216" or var_8_1 == "219" or var_8_1 == "298" then
					if var_8_1 == "299" or var_8_1 == "119" or var_8_1 == "292" or var_8_1 == "293" or var_8_1 == "297" or var_8_1 == "296" or var_8_1 == "3" or var_8_1 == "289" or var_8_1 == "127" or var_8_1 == "118" or var_8_1 == "112" then
						lua_thread.create(function()
							local var_25_0 = "Skin 152 | Æ | 6.000.000(4.200.000 ïðè /boostinfo)"
							local var_25_1, var_25_2, var_25_3 = string.match(var_25_0, "Skin (.+) | (.+) | (.+)")
							local var_25_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_25_3)
					...
					elseif var_8_1 == "152" or var_8_1 == "216" or var_8_1 == "219" or var_8_1 == "298" then
						lua_thread.create(function()
							local var_26_0 = "Skin 152 | Æ | 6.000.000(4.200.000 ïðè /boostinfo)"
							local var_26_1, var_26_2, var_26_3 = string.match(var_26_0, "Skin (.+) | (.+) | (.+)")
							local var_26_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_26_3)
				...
				elseif var_8_1 == "61" or var_8_1 == "5" or var_8_1 == "126" or var_8_1 == "290" or var_8_1 == "248" or var_8_1 == "223" or var_8_1 == "144" or var_8_1 == "208" or var_8_1 == "272" or var_8_1 == "261" or var_8_1 == "190" or var_8_1 == "237" or var_8_1 == "148" or var_8_1 == "263" then
					if var_8_1 == "61" or var_8_1 == "5" or var_8_1 == "126" or var_8_1 == "290" or var_8_1 == "248" or var_8_1 == "223" or var_8_1 == "144" or var_8_1 == "208" or var_8_1 == "272" or var_8_1 == "261" then
						lua_thread.create(function()
							local var_27_0 = "Skin 190 | Æ | 8.000.000(5.600.000 ïðè /boostinfo)"
							local var_27_1, var_27_2, var_27_3 = string.match(var_27_0, "Skin (.+) | (.+) | (.+)")
							local var_27_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_27_3)
					...
					elseif var_8_1 == "190" or var_8_1 == "237" or var_8_1 == "148" or var_8_1 == "263" then
						lua_thread.create(function()
							local var_28_0 = "Skin 190 | Æ | 8.000.000(5.600.000 ïðè /boostinfo)"
							local var_28_1, var_28_2, var_28_3 = string.match(var_28_0, "Skin (.+) | (.+) | (.+)")
							local var_28_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_28_3)
				...
				elseif var_8_1 == "294" or var_8_1 == "295" or var_8_1 == "100" or var_8_1 == "46" or var_8_1 == "113" or var_8_1 == "125" or var_8_1 == "76" or var_8_1 == "91" or var_8_1 == "141" or var_8_1 == "150" or var_8_1 == "169" or var_8_1 == "214" then
					if var_8_1 == "294" or var_8_1 == "295" or var_8_1 == "100" or var_8_1 == "46" or var_8_1 == "113" or var_8_1 == "125" then
						lua_thread.create(function()
							local var_29_0 = "Skin 76 | Æ | 10.000.000(7.000.000 ïðè /boostinfo)"
							local var_29_1, var_29_2, var_29_3 = string.match(var_29_0, "Skin (.+) | (.+) | (.+)")
							local var_29_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_29_3)
					...
					elseif var_8_1 == "76" or var_8_1 == "91" or var_8_1 == "141" or var_8_1 == "150" or var_8_1 == "169" or var_8_1 == "214" then
						lua_thread.create(function()
							local var_30_0 = "Skin 76 | Æ | 10.000.000(7.000.000 ïðè /boostinfo)"
							local var_30_1, var_30_2, var_30_3 = string.match(var_30_0, "Skin (.+) | (.+) | (.+)")
							local var_30_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_30_3)
				...
				elseif var_8_1 == "51" or var_8_1 == "52" or var_8_1 == "72" or var_8_1 == "94" or var_8_1 == "133" or var_8_1 == "206" or var_8_1 == "262" or var_8_1 == "85" or var_8_1 == "87" or var_8_1 == "138" or var_8_1 == "139" or var_8_1 == "244" or var_8_1 == "257" or var_8_1 == "256" then
					if var_8_1 == "51" or var_8_1 == "52" or var_8_1 == "72" or var_8_1 == "94" or var_8_1 == "133" or var_8_1 == "206" or var_8_1 == "262" then
						lua_thread.create(function()
							local var_31_0 = "Skin 85 | Æ | 20.000.000(14.000.000 ïðè /boostinfo)"
							local var_31_1, var_31_2, var_31_3 = string.match(var_31_0, "Skin (.+) | (.+) | (.+)")
							local var_31_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Ì", var_31_3)
					...
					elseif var_8_1 == "85" or var_8_1 == "87" or var_8_1 == "138" or var_8_1 == "139" or var_8_1 == "244" or var_8_1 == "257" or var_8_1 == "256" then
						lua_thread.create(function()
							local var_32_0 = "Skin 85 | Æ | 20.000.000(14.000.000 ïðè /boostinfo)"
							local var_32_1, var_32_2, var_32_3 = string.match(var_32_0, "Skin (.+) | (.+) | (.+)")
							local var_32_4 = string.format("/pm %s Ñêèí | ID: %s | %s | %s", var_8_0, var_8_1, "Æ", var_32_3)
				...
				sampAddChatMessage(" Ñêèí '" .. var_8_1 .. "' íå íàéäåí. Ïðîâåðüòå ïðàâèëüíîñòü íàïèñàíèÿ!", -1)
			end
		else
			sampAddChatMessage(" /skinid [ID] [ID ñêèíà]", -1)
		end
	end)
	...
	sampRegisterChatCommand("asupotv", function()
		...
		DialogText = "Äàòà\tÎòâåòû / Îòâ.(!)\tPayDay\tÇàðïëàòà\n" .. DialogText .. "\nÂñåãî:\t" .. var_34_7 .. " / " .. var_34_8 .. "\t" .. var_34_6 .. "\t" .. var_34_6 * 30000 .. "\nÎòâåòû(w): \t" .. var_0_77.Weekset.online .. " / " .. var_0_77.Weekset.onlinereting

		sampShowDialog(8228, "Support Helper | Samp-RP", DialogText, "Âûáðàòü", "Íàçàä", 5)
	end)
	...
	while true do
		...
		if editingPos and var_0_88.active6.v then
			showCursor(true)
			renderFontDrawText(font, "{" .. var_0_76.tag.color .. "}" .. "Êàê ïîäíÿòü áàáëà?", var_0_80, var_0_81, -1)

			curX, curY = getCursorPos()
			var_0_80, var_0_81 = curX, curY

			if wasKeyPressed(32) then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Íîâîå ïîëîæåíèå {FFA500}ñîõðàíåíî{FFFFFF}: {FFE4B5}Õ: {00BFFF}" .. curX .. "{FFFFFF}, {FFE4B5}Y: {00BFFF}" .. curY, 16776960)
		...
		if not editingPosP3 and var_0_88.activeokno_infoscreen_otvet_.v then
			...
			local var_6_8 = "Ñåãîäíÿøíÿÿ äàòà: " .. os.date("%d.%m.%Y") .. "\nÎòâåòû / Îòâ.(!): " .. var_0_88.infoscreenaOtvet .. " / " .. var_0_88.infoscreenaRotvet .. "\nPayDay: " .. var_0_88.infoscreen_aHour .. "\nÇàðïëàòà: " .. var_0_88.infoscreen_aHour * 30000
		...
		if editingPosP and var_0_88.active5.v then
			...
			if #var_0_46 == 0 then
				local var_6_11 = "Çäåñü áóäåò îòîáðàæàòüñÿ îêíî ñ âîïðîñàìè"
			...
			for iter_6_6 = var_0_48 == 0 and #var_0_46 or #var_0_46 - var_0_48, var_0_48 == 0 and #var_0_46 - var_0_76.tag.global_Line - var_0_48 + 1 or #var_0_46 - var_0_76.tag.global_Line - var_0_48 - var_0_48 + 1, -1 do
				if var_0_46[iter_6_6] ~= nil then
					local var_6_13, var_6_14 = string.match(var_0_46[iter_6_6], "Âîïðîñ .+%[(%d+)%]<%d+lvl>: (.+)")
			...
			if wasKeyPressed(32) then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Íîâîå ïîëîæåíèå {FFA500}ñîõðàíåíî{FFFFFF}: {FFE4B5}Õ: {00BFFF}" .. curXX .. "{FFFFFF}, {FFE4B5}Y: {00BFFF}" .. curYY, 16776960)
		...
		if editingPosP2 and var_0_88.activerenderchatsupports.v then
			...
			if #var_0_47 == 0 then
				local var_6_18 = "Çäåñü áóäåò îòîáðàæàòüñÿ âûâåäåííûé ÷àò èãðîâûõ ïîìîùíèêîâ"
			...
			if wasKeyPressed(32) then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Íîâîå ïîëîæåíèå {FFA500}ñîõðàíåíî{FFFFFF}: {FFE4B5}Õ: {00BFFF}" .. curXX1 .. "{FFFFFF}, {FFE4B5}Y: {00BFFF}" .. curYY1, 16776960)
		...
		if editingPosP3 and var_0_88.activeokno_infoscreen_otvet_.v then
			...
			local var_6_23 = "Ñåãîäíÿøíÿÿ äàòà: " .. os.date("%d.%m.%Y") .. "\nÎòâåòû / Îòâ.(!): " .. var_0_88.infoscreenaOtvet .. "/" .. var_0_88.infoscreenaRotvet .. "\nPayDay: " .. var_0_88.infoscreen_aHour .. "\nÇàðïëàòà:" .. var_0_88.infoscreen_aHour * 30000
			...
			if wasKeyPressed(32) then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Íîâîå ïîëîæåíèå {FFA500}ñîõðàíåíî{FFFFFF}: {FFE4B5}Õ: {00BFFF}" .. curXX2 .. "{FFFFFF}, {FFE4B5}Y: {00BFFF}" .. curYY2, 16776960)
...
function doDialog()
	if sampGetDialogCaption() == "Ïîèñê ëèäåðîâ" then
...
function doWindow()
	...
	if var_0_88.active5.v and not sampIsScoreboardOpen() and sampIsChatVisible() and not sampIsDialogActive() and not isKeyDown(116) and not isKeyDown(121) and not editingPosP then
		...
		if #var_0_46 == 0 then
			local var_39_5 = "Çäåñü áóäåò îòîáðàæàòüñÿ îêíî ñ âîïðîñàìè"
		...
		for iter_39_0 = var_0_48 == 0 and #var_0_46 or #var_0_46 - var_0_48, var_0_48 == 0 and #var_0_46 - var_0_76.tag.global_Line - var_0_48 + 1 or #var_0_46 - var_0_76.tag.global_Line - var_0_48 - var_0_48 + 1, -1 do
			if var_0_46[iter_39_0] ~= nil then
				local var_39_7, var_39_8 = string.match(var_0_46[iter_39_0], "Âîïðîñ .+%[(%d+)%]<%d+lvl>: (.+)")
	...
	if var_0_88.activerenderchatsupports.v and not sampIsScoreboardOpen() and sampIsChatVisible() and not sampIsDialogActive() and not isKeyDown(116) and not isKeyDown(121) and not editingPosP2 then
		...
		if #var_0_47 == 0 then
			...
			local var_39_15 = "Çäåñü áóäåò îòîáðàæàòüñÿ âûâåäåííûé ÷àò èãðîâûõ ïîìîùíèêîâ"
...
if arg_41_1 == " Âû íå ñàïïîðò" then
		var_0_88.activeAutoSduty.v = false
		var_0_76.tag.activeAutoSduty = false

		savesettings()
		sampAddChatMessage(var_0_13 .. " {FFFFFF}Àâòîìàòè÷åñêîå íà÷àëî ðàáî÷åãî äíÿ {FF0000}îòêëþ÷åí", 16776960)

		var_0_42 = 0
	end

	if arg_41_1 == " Ðàáî÷èé äåíü íà÷àò" and var_0_43 then
		if var_0_42 == 2 then
			var_0_42 = 0
		end
	...
	if arg_41_1 == " Ðàáî÷èé äåíü çàêîí÷åí" and var_0_43 then
		if var_0_42 == 2 then
			var_0_42 = 1
		end
...
if var_0_88.aifaqsystem.v then
	...
	if arg_41_1:find("Âîïðîñ") then
		...
		if id and question then
			...
			sampAddChatMessage(
				"{FFFF00}Support Helper |  Âîïðîñ ñîõðàíåí!",
				-1
			)
		end
	end
	...
	if arg_41_1:find(" to ") then
		...
		if playerId and answer then
			...
			if pendingQuestions[playerId] then
				...
				sampAddChatMessage(
					"{FFFF00}Support Helper |  Îòâåò ñîõðàíåí!",
					-1
				)
	...
	if arg_41_1 == " Íå ôëóäè!" and var_0_42 == 2 then
		var_0_42 = 1
	end
	if var_0_88.aifaqsystem.v then
	-- sampAddChatMessage("[AI DEBUG] " .. arg_41_1, -1) äåáàã îáðàáîòêè ñåðâåðíûõ ñîîáùåíèè
end

	if string.find(arg_41_1, "..Âîïðîñ .+%[(%d+)%].+") and not arg_41_1:find("(.+) ..Âîïðîñ .+%[(%d+)%].+") then
		local var_41_0, var_41_1 = string.match(arg_41_1, "..Âîïðîñ .+%[(%d+)%]<%d+lvl>: (.+)")
	...
	if foundAnswer then
		...
		sampAddChatMessage(
			"{FFFF00}Support Helper |  Íàéäåí îòâåò: " .. foundAnswer,
			-1
		)
	end

	sampAddChatMessage(
		"{FFFF00}Support Helper | {ffffff}Âîïðîñ ñîõðàíåí!",
		-1
	)
	...
	if string.find(arg_41_1, "Âû îòâåòèëè íà âîïðîñ èç ñïèñêà. Âîïðîñ íèæå óäàëåí") and arg_41_0 == 1790050303 then
		lua_thread.create(function()
	...
	if string.find(arg_41_1, " Äîì: .+ | Êëàññ: .+ | Öåíà: .+ âèðò") and var_0_51 == 1 then
		var_0_52 = arg_41_1
		var_0_51 = 2
	end

	if arg_41_1 == " Âû íå òàêñèñò èëè íå íà ñëóæáå" then
		sfarmID = nil
	end
	...
	if var_0_76.tag.activevop and arg_41_1:find("..Âîïðîñ .+%[(%d+)%].+") and not arg_41_1:find("(.+) ..Âîïðîñ .+%[(%d+)%].+") then
...
function var_0_5.onShowDialog(arg_45_0, arg_45_1, arg_45_2, arg_45_3, arg_45_4, arg_45_5)
	if arg_45_1 == 5 and string.find(arg_45_5, "Ôðàêöèÿ") and arg_45_2 == "Ëèäåðû" and sleaders ~= nil then
		leaders = ""
		dliaders = {}
		...
		for iter_45_0 in string.gmatch(arg_45_5, "[^\n]+") do
			if iter_45_0.find(iter_45_0, "%[%d+%] (.+)\t(.+)") then
                ...
                dliaders[#dliaders + 1] = "Íèê ëèäåðà: " .. var_45_0 .. " | Ôðàêöèÿ: " .. var_45_1
		...
		if checkLeaders then
			lua_thread.create(function()
				if #leaders > 0 then
					sampShowDialog(2256, "Ïîèñê ëèäåðîâ", "Íàæìèòå íà ñòðîêó ÷òîáû âñòàâèòü â ÷àò\n" .. leaders, "Âûáðàòü", "Çàêðûòü", 5)
				else
					sampShowDialog(0, "Ïîèñê ëèäåðîâ", "{FFFFFF}Ïîèñê ïî çàïðîñó: '" .. sleaders .. "' íå äàë ðåçóëüòàòîâ", "Âûáðàòü", "Çàêðûòü", 0)
				end
			end)
	...
	if arg_45_1 == 2 and sfarmID ~= nil and string.find(arg_45_5, "{00AB06}Ôåðìåðîâ") and string.find(arg_45_5, "{00AB06}Ïðîðàáîâ") then
		local var_45_2 = 0
		local var_45_3 = ""
		...
		for iter_45_1 in string.gmatch(arg_45_5, "[^\n]+") do
			...
			if var_45_2 == 1 then
				var_45_3 = "/pm " .. sfarmID .. " [Ôåðìà|Ðàáî÷èõ|Çà êóñò] "
			else
				local var_45_4, var_45_5, var_45_6 = iter_45_1.match(iter_45_1, "%[.+%] {FFFFFF}%[Ôåðìà ¹(.+)%]  {00AB06}Ôåðìåðîâ (.+)  {FFFF00}Öåíà çà êóñò (.+)$")
	...
	if arg_45_1 == 2 and skazID ~= nil and var_0_59 == 2 and string.find(arg_45_5, "Ìàôèè") and arg_45_2 == "Ðåéòèíã" then
	...
	if var_0_59 == 3 and arg_45_2 == "Èñòîðèÿ" then
	...
	if arg_45_1 == 5 and var_0_59 == 4 and string.find(arg_45_2, "Ìåíþ") then
		local var_45_7 = string.match(arg_45_5, "%[3%] (%a+).+")
		local var_45_8 = string.match(arg_45_5, "%[4%] (%a+).+")

		kaztext = string.format("Äðàêîíû ó %s | Êàëèãóëà ó %s", var_45_7:gsub("Russian", "Russian Mafia"), var_45_8:gsub("Russian", "Russian Mafia"))
		var_0_59 = 0
		...
		if sCarID ~= nil and sCarName ~= nil then
			...
			lua_thread.create(function()
				...
				if #var_53_0 > 0 then
					...
					if var_53_2 == "S" then
						if boostCar then
							sampAddChatMessage(" Ñêèäêè äëÿ àâòîìîáèëÿ '" .. sCarName .. "' íåòó. Ïðîâåðüòå ïðàâèëüíîñòü íàïèñàíèÿ!", -1)
						else
							local var_53_6 = var_53_3:gsub("%.", "")
							local var_53_7 = tonumber(var_53_5) / 100
							local var_53_8 = string.format("/pm %s%s [%s] [%s] > %s$ > 1 ïðîöåíò: %s$", sCarID, var_53_1, var_53_2, var_53_4, "Öåíà: îò " .. var_53_6, var_53_5)
						...
						local var_53_12 = string.format("/pm %s%s [%s] [%s] > %s$ > 1 ïðîöåíò: %s$", sCarID, var_53_1, var_53_2, var_53_4, boostCar and "Öåíà ñî ñêèäêîé " .. var_53_10 or "Öåíà â ñàëîíå " .. var_53_9, var_53_5)
					...
					sampAddChatMessage(" Àâòîìîáèëü '" .. sCarName .. "' íå íàéäåí. Ïðîâåðüòå ïðàâèëüíîñòü íàïèñàíèÿ!", -1)
				end
			end)
		else
			sampAddChatMessage(" /car [ID] [Íàçâàíèå]", -1)
		end
		...
		if var_52_3 ~= nil and var_52_4 ~= nil then
			lua_thread.create(function()
				...
				if #var_54_0 > 0 then
					...
					sampAddChatMessage(" GPS '" .. var_52_4 .. "' íå íàéäåí. Ïðîâåðüòå ïðàâèëüíîñòü íàïèñàíèÿ!", -1)
				end
			end)
		else
			sampAddChatMessage(" /sgps [ID èãðîêà] [Íàçâàíèå îðãàíèçàöèè]", -1)
			sampAddChatMessage(" Íà÷íèòå ââîä  çàòåì âûáåðèòå íóæíûé âàðèàíò èç ñïèñêà", -1)
		end
...
function var_0_6.OnDrawFrame()
	if var_0_88.imgui_active.v then
		...
		var_0_6.Begin(u8("  Íàñòðîéêà îòâåòîâ"), var_0_88.imgui_active, var_0_6.WindowFlags.NoResize + var_0_6.WindowFlags.NoCollapse)

		if not var_0_40 and var_0_6.Combo(u8("Ñïèñîê"), var_0_61, var_0_60) and var_0_61.v ~= 0 and var_0_61.v ~= #var_0_60 then
		...
		if not var_0_40 then
			...
			if var_0_6.Button(u8("Äîáàâèòü â ñïèñîê íîâûé ïîäïóíêò")) then
				local var_59_0 = "Ñïèñîê îòâåòîâ ¹" .. #var_0_36 + 1
		...
		if var_0_40 or var_0_61.v == 0 then
			...
			if var_0_6.Button(u8(" Ðåäàêòèðîâàòü"), var_0_6.ImVec2(110, 20)) then
				var_0_40 = true
		...
		if var_0_40 or var_0_61.v == 0 then
			...
			if var_0_6.Button(u8(" Óäàëèòü"), var_0_6.ImVec2(125, 20)) then
				local var_59_1 = 0
				...
				sampAddChatMessage(var_0_13 .. " {FFFFFF} Ïîäïóíêò îòâåòîâ {FFE4B5}\"" .. u8:decode(var_0_74.v) .. "\" {FF0000}óäàëåí.", 16776960)
		...
		if var_0_73 ~= 0 then
			...
			if var_0_40 then
				...
				if var_0_6.Button(u8(" Ñîõðàíèòü"), var_0_6.ImVec2(125, 20)) then
					var_0_36[var_0_61.v].name = u8:decode(var_0_74.v)
					var_0_36[var_0_61.v].text1 = string.gsub(u8:decode(var_0_75.v), "\n", "&")
					var_0_40 = false

					var_0_1.save(var_0_36, var_0_3)
					sampAddChatMessage(var_0_13 .. " {FFFFFF} Ïîäïóíêò îòâåòîâ {FFE4B5}\"" .. u8:decode(var_0_74.v) .. "\" {FFA500}ñîõðàíåí.", 16776960)
				...
				if var_0_6.Button(u8("Îòìåíà"), var_0_6.ImVec2(125, 20)) then
					var_0_40 = false
					var_0_74.v = u8(var_0_36[var_0_61.v].name)
					var_0_75.v = string.gsub(u8(var_0_36[var_0_61.v].text1), "&", "\n")
				end
	...
	if var_0_88.imgui_active2.v then
		...
		var_0_6.SetNextWindowSize(var_0_6.ImVec2(937, 504), var_0_6.Cond.FirstUseEver)
		var_0_6.SetNextWindowPos(var_0_6.ImVec2(var_0_71 / 2, var_0_72 / 2), var_0_6.Cond.FirstUseEver, var_0_6.ImVec2(0.5, 0.5))
		var_0_6.Begin(u8(" Ñïèñîê îòâåòîâ"), var_0_88.imgui_active2)

		if var_0_6.Combo(u8("Ñïèñîê"), var_0_63, var_0_62) and var_0_63.v ~= 0 and var_0_63.v ~= #var_0_62 then
		...
		if var_0_73 == 0 or var_0_63.v == 0 then
			...
			var_0_6.InputText(u8("Ïîèñê"), var_0_9)
			var_0_6.Separator()
	...
	if var_0_88.imgui_active3.v then
		...
		var_0_6.SetNextWindowPos(var_0_6.ImVec2(var_0_71 / 2, var_0_72 / 2), var_0_6.Cond.FirstUseEver, var_0_6.ImVec2(0.5, 0.5))
		var_0_6.Begin(var_0_11.ICON_CLIPBOARD .. u8(" Ãëàâíîå îêíî Support Helper"), nil, var_0_6.WindowFlags.NoResize + var_0_6.WindowFlags.NoCollapse + var_0_6.WindowFlags.NoMove + var_0_6.WindowFlags.NoTitleBar + var_0_6.WindowFlags.NoScrollbar)
		...
		if var_0_66 then
			...
			var_0_6.SetCursorPosX(170)
			var_0_6.TextColoredRGB(u8("Ðàçðàáîò÷èê ñêðèïòà: ") .. var_0_11.ICON_USER_CIRCLE .. " {FFE4B5}Garfusha     ")
			var_0_6.SetCursorPosX(170)
			var_0_6.TextColoredRGB(u8("Òåêóùàÿ âåðñèÿ: {00FF00}àêòóàëüíàÿ {008000}") .. var_0_11.ICON_CHECK_CIRCLE .. "     ")
			...
			if var_0_6.Button("" .. var_0_11.ICON_CLOCK_O) then
				...
				if var_0_76.tag.SupportName == nickname and var_0_41 then
					...
					sampAddChatMessage(var_0_13 .. " {FF0000}Îøèáêà! {FFFFFF}Äàííîå äåéñòâèå âîçìîæíî ñäåëàòü òîëüêî ñ îñíîâíîãî àêêàóíòà", 16776960)
				end
			end
			...
			if var_0_6.Button("" .. var_0_11.ICON_ID_CARD .. u8(" Íàñòðîéêà àêêàóíòà"), var_0_6.ImVec2(220, 80)) then
				var_0_64 = 1
				var_0_66 = false
			end
			...
			if var_0_6.Button(u8("        ") .. var_0_11.ICON_COMMENTS .. u8(" Íàñòðîéêà ÷àòà\n      (íàñòðîéêà îòîáðàæåíèÿ\n ñîîáùåíèé, ôèëüòðàöèè ÷àòà è\n              äîï. ôóíêöèé.)"), var_0_6.ImVec2(220, 80)) then
				var_0_64 = 2
				var_0_66 = false
			end
			...
			if var_0_6.Button("" .. var_0_11.ICON_CALENDAR .. u8(" Ñòàòèñòèêà ðàáîòû"), var_0_6.ImVec2(220, 80)) then
				...
				DialogText = "Äàòà\tÎòâåòû / Îòâ.(!)\tPayDay\tÇàðïëàòà\n" .. DialogText .. "\nÂñåãî:\t" .. var_59_11 .. " / " .. var_59_12 .. "\t" .. var_59_10 .. "\t" .. var_59_10 * 30000 .. "\nÎòâåòû(w): \t" .. var_0_77.Weekset.online .. " / " .. var_0_77.Weekset.onlinereting

				sampShowDialog(8888, "Support Helper | Samp-RP", DialogText, "Âûáðàòü", "Íàçàä", 5)
			...
			if var_0_6.Button("           " .. var_0_11.ICON_COG .. u8(" Áèíä êëàâèø\n    (íàñòðîéêà ãîðÿ÷èõ êëàâèø\n     äëÿ îòâåòà, îòêðûòèÿ îêîí\n óïðàâëåíèÿ ôóíêöèÿìè ñêðèïòà"), var_0_6.ImVec2(220, 80)) then
				var_0_64 = 3
				var_0_66 = false
			end
			...
			if var_0_6.Button("" .. var_0_11.ICON_TEXT_HEIGHT .. u8(" Íàñòðîéêè èíòåðôåéñà"), var_0_6.ImVec2(220, 80)) then
				var_0_64 = 4
				var_0_66 = false
			end
			...
			if var_0_6.Button("" .. var_0_11.ICON_LIST .. u8(" Êîìàíäû ñêðèïòà"), var_0_6.ImVec2(220, 80)) then
		...
		if var_0_64 == 1 then
			...
			var_0_6.TextColoredRGB(u8("\t\t\t\t\t\t\t\t\t\t\t\t\t\t   {808080}» {EEE8AA}Íàñòðîéêà àêêàóíòà {808080}«"))
			var_0_6.Separator()
			var_0_6.TextColoredRGB(u8("Âàø NickName: {FFE4B5}") .. var_0_76.tag.SupportName)

			if var_0_6.Button(u8("Èñïîëüçîâàòü êàê îñíîâíîé àêêàóíò")) then
			...
			if var_0_6.IsItemHovered() then
				...
				var_0_6.TextUnformatted(u8("Òîëüêî äëÿ íåãî áóäåò ðàáîòàòü àâòîìàòè÷åñêîå íà÷àëî äíÿ"))
				var_0_6.EndTooltip()
			end

			var_0_6.Text(u8("Àâòîìàòè÷åñêîå íà÷àëî äíÿ (sduty)"))
			var_0_6.SameLine()
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Ðàñøèðåííûé ÷àò ïîìîùíèêîâ"))
			var_0_6.SameLine()
			...
			if var_0_6.IsItemHovered() then
				var_0_6.BeginTooltip()
				var_0_6.TextUnformatted(u8("Äîáàâëÿåò ID èãðîêà ê íèêó â ÷àòå (/sc)\nÔîðìàò: Nick_Name > Nick_Name[ID]"))
				var_0_6.EndTooltip()
			end

			var_0_6.Separator()
			var_0_6.Text(u8("Âûâîä ÷àòà èãðîâûõ ïîìîùíèêîâ â îòäåëüíîå îêíî"))
			var_0_6.SameLine()
			...
			if var_0_6.Button(u8("Ñìåíèòü ïîçèöèþ âûâîäà ÷àòà èãðîâûõ ïîìîùíèêîâ")) and var_0_88.activerenderchatsupports.v then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Äëÿ ñîõðàíåíèÿ ïîëîæåíèÿ íàæìèòå {ff004d}ÏÐÎÁÅË", 16776960)
			...
			if var_0_88.activerenderchatsupports.v then
				var_0_6.Text(u8("Cêðûòü ÷àò ñàïïîðòîâ â ÷àòå"))
				var_0_6.SameLine()
				...
				var_0_6.Text(u8("Êîë-âî ñòðîê â îêíå âûâîäà ÷àòà èãðîâûõ ïîâîùíèêîâ: "))
				var_0_6.SameLine()
			...
			if var_0_6.Button("" .. var_0_11.ICON_FLOPPY_O .. u8(" Ñîõðàíèòü íàñòðîéêè")) then
				...
				sampAddChatMessage(var_0_13 .. " {FFFFFF} Íàñòðîéêè ñêðèïòà óñïåøíî {FFA500}ñîõðàíåíû", 16776960)
			end
			...
			if var_0_6.IsItemHovered() then
				var_0_6.BeginTooltip()
				var_0_6.TextUnformatted(u8("Åñëè ïîñëå íàñòðîéêè êàêîãî ëèáî ïàðàìåðàòðà / ïóíêòà / ïîäïóíêòà â ýòîì îêíå\nâû íå íàæìåòå êíîïêó \"ñîõðàíèòü íàñòðîéêè\", òî, èçìåíåíèÿ íå âñòóïÿò â ñèëó"))
				var_0_6.EndTooltip()
			end
		...
		if var_0_64 == 2 then
			...
			var_0_6.TextColoredRGB(u8("\t\t\t\t\t\t\t\t\t\t\t\t\t\t       {808080}» {EEE8AA}Íàñòðîéêà ÷àòà {808080}«"))
			var_0_6.Separator()
			var_0_6.Text(u8("Ñêðûâàòü âîïðîñû èç ÷àòà"))
			var_0_6.SameLine()
			...
			var_0_6.Text(u8("Ñêðûâàòü ÷óæèå îòâåòû èç ÷àòà"))
			var_0_6.SameLine()
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Ïåðåêðàñèòü ÷àò èãðîâûõ ïîìîùíèêîâ"))
			var_0_6.SameLine()
			...
			var_0_6.Text(u8("Öâåò ÷àòà èãðîâûõ ïîìîùíèêîâ: "))
			var_0_6.SameLine()
			var_0_6.PushItemWidth(120)
			...
			if var_0_6.IsItemHovered() then
				var_0_6.BeginTooltip()
				var_0_6.TextUnformatted(u8("Öâåò òåêñòà äîëæåí áûòü â ôîðìàòå HEX. Ïðèìåð: FFFFFF"))
				var_0_6.EndTooltip()
			end

			var_0_6.Separator()
			var_0_6.Text(u8("Àâòîìàòè÷åñêîå íàïîëíåíèå áàçû âîïðîñîâ è îòâåòîâ"))
var_0_6.SameLine()
...
if var_0_6.IsItemHovered() then
	var_0_6.BeginTooltip()
	var_0_6.Text(u8("Ñèñòåìà àâòîìàòè÷åñêè ñîõðàíÿåò âîïðîñû èãðîêîâ\nè îòâåòû ñàïïîðòîâ â ëîêàëüíóþ áàçó äàííûõ.\nÏðè ïîâòîðíûõ ïîõîæèõ âîïðîñàõ ýòà ôóíêöèÿ\nïîäñêàæåò ãîòîâûé îòâåò.\n\nÏîñëå êàæäîãî ñîõðàíåíèÿ âîïðîñà èëè îòâåòà\nâ ÷àò âûâîäèòñÿ óâåäîìëåíèå, âîçìîæåí ôëóä."))
	var_0_6.EndTooltip()
end

var_0_6.Separator()
			var_0_6.Text(u8("Ïåðåêðàñèòü âîïðîñ â ÷àòå"))
			var_0_6.SameLine()
			...
			var_0_6.Text(u8("Öâåò âîïðîñà â ÷àòå: "))
			var_0_6.SameLine()
			var_0_6.PushItemWidth(120)
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Ïåðåêðàñèòü ÷óæèå îòâåòû â ÷àòå"))
			var_0_6.SameLine()
			...
			var_0_6.Text(u8("Öâåò ÷óæèõ îòâåòîâ: "))
			var_0_6.SameLine()
			var_0_6.PushItemWidth(120)
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Ïåðåêðàñèòü ìîè îòâåòû â ÷àòå"))
			var_0_6.SameLine()
			...
			var_0_6.Text(u8("Öâåò ìîèõ îòâåòîâ: "))
			var_0_6.SameLine()
			var_0_6.PushItemWidth(120)
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Ïîêàçûâàòü èíôîðìàöèþ íà ýêðàíå"))
			var_0_6.SameLine()
			...
			if var_0_6.Button(u8("Ñìåíèòü ïîçèöèþ èíôîðìàöèè íà ýêðàíå")) and var_0_88.activeokno_infoscreen_otvet_.v then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Äëÿ ñîõðàíåíèÿ ïîëîæåíèÿ íàæìèòå {ff004d}ÏÐÎÁÅË", 16776960)
			...
			if var_0_88.activeokno_infoscreen_otvet_.v then
				var_0_6.Text(u8("Øðèôò òåêñòà èíôîðìàöèè íà ýêðàíå: "))
				var_0_6.SameLine()
				var_0_6.PushItemWidth(120)
				...
				if var_0_6.IsItemHovered() then
					var_0_6.BeginTooltip()
					var_0_6.TextUnformatted(u8("Øðèôò êîòîðûé âû òóò óêàæèòå äîëæåí áûòü óñòàíîâëåí ó âàñ íà êîìïüþòåðå"))
					var_0_6.EndTooltip()
				end

				var_0_6.Text(u8("Ïåðåêðàñèòü èíôîðìàöèþ íà ýêðàíå"))
				var_0_6.SameLine()
				...
				if var_0_88.active_infoscreen_otvet_ then
					var_0_6.Text(u8("Öâåò èíôîðìàöèè íà ýêðàíå: "))
					var_0_6.SameLine()
					var_0_6.PushItemWidth(120)
				...
				var_0_6.Text(u8("Ðàçìåð òåêñòà èíôîðìàöèè íà ýêðàíå: "))
				var_0_6.SameLine()
				var_0_6.PushItemWidth(120)
				...
				var_0_6.PopItemWidth()
				var_0_6.Text(u8("Ñòèëü òåêñòà èíôîðìàöèè íà ýêàðíå: "))
				var_0_6.SameLine()
				var_0_6.PushItemWidth(120)
			...
			if var_0_6.Button("" .. var_0_11.ICON_FLOPPY_O .. u8(" Ñîõðàíèòü íàñòðîéêè")) then
				if #var_0_88.supchatcolor.v:gsub(" ", "") == 6 and #var_0_88.vopchatcolor.v:gsub(" ", "") == 6 and #var_0_88.infoscreen_otvet_.v:gsub(" ", "") == 6 and #var_0_88.otvetcolor.v:gsub(" ", "") == 6 and #var_0_88.myotvetcolor.v:gsub(" ", "") == 6 then
					...
					sampAddChatMessage(var_0_13 .. " {FF0000}Îøèáêà! {FFFFFF}Ñîõðàíåíèå íå ïðîèçîøëî. Öâåò äîëæåí áûòü èç 6 ñèìâîëîâ, ïðèìåð: FFFFFF", 16776960)
				end
			end
		...
		if var_0_64 == 3 then
			...
			var_0_6.TextColoredRGB(u8("\t\t\t\t\t\t\t\t\t\t\t\t\t\t         {808080}» {EEE8AA}Áèíä êëàâèø {808080}«"))
			var_0_6.Separator()
			var_0_6.Text(u8("Êëàâèøà äëÿ îòâåòà íà ïîñëåäíèé âîïðîñ:"))
			var_0_6.SameLine()
			var_0_6.TextColoredRGB(u8("{FFE4B5}") .. var_0_76.tag.KeyPMLast:gsub("VK_", ""))

			if var_0_6.Button(u8("Ñìåíèòü êëàâèøó äëÿ îòâåòà íà ïîñëåäíèé âîïðîñ")) then
				var_0_88.imgui_active3.v = false

				sampShowDialog(10, "Ñìåíà êëàâèøè", "Íàæìèòå íà íóæíóþ êëàâèøó", "Âûáðàòü", "Íàçàä", 0)
				lua_thread.create(function()
					local var_60_0 = ""
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Êëàâèøà äëÿ ïîêàçà / ñêðûòèÿ îêíà ñ âîïðîñàìè:"))
			var_0_6.SameLine()
			var_0_6.TextColoredRGB(u8("{FFE4B5}") .. var_0_76.tag.Keyokno:gsub("VK_", ""))

			if var_0_6.Button(u8("Ñìåíèòü êëàâèøó äëÿ ïîêàçà / ñêðûòèÿ îêíà ñ âîïðîñàìè")) then
				var_0_88.imgui_active3.v = false

				sampShowDialog(11, "Ñìåíà êëàâèøè", "Íàæìèòå íà íóæíóþ êëàâèøó", "Âûáðàòü", "Íàçàä", 0)
				lua_thread.create(function()
					local var_61_0 = ""
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Êëàâèøà äëÿ îòâåòà:"))
			var_0_6.SameLine()
			var_0_6.TextColoredRGB(u8("{FFE4B5}") .. var_0_76.tag.KeyWindowPM:gsub("VK_", "") .. u8("{FFFFFF} + íîìåð ñòðîêè"))

			if var_0_6.Button(u8("Ñìåíèòü êëàâèøó äëÿ îòâåòà")) then
				var_0_88.imgui_active3.v = false

				sampShowDialog(12, "Ñìåíà êëàâèøè", "Íàæìèòå íà íóæíóþ êëàâèøó", "Âûáðàòü", "Íàçàä", 0)
				lua_thread.create(function()
					local var_62_0 = ""
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Êëàâèøà äëÿ ïðîìîòêè âûâåäåííîãî ÷àòà èãðîâûõ ïîìîùíèêîâ:"))
			var_0_6.SameLine()
			var_0_6.TextColoredRGB(u8("{FFE4B5}") .. var_0_76.tag.keyrenderchatsupports:gsub("VK_", "") .. u8("{FFFFFF} + êîëåñèêî ìûøè"))

			if var_0_6.Button(u8("Ñìåíèòü êëàâèøó äëÿ ïðîìîòêè âûâåäåííîãî ÷àòà èãðîâûõ ïîìîùíèêîâ")) then
				var_0_88.imgui_active3.v = false
		...
		if var_0_64 == 4 then
			...
			var_0_6.TextColoredRGB(u8("\t\t\t\t\t\t\t\t\t\t\t\t\t\t             {808080}» {EEE8AA}Øðèôòû {808080}«"))
			var_0_6.Separator()
			var_0_6.Text(u8("Âîïðîñ íà ýêðàíå ïðè ââîäå îòâåòà"))
			var_0_6.SameLine()
			...
			if var_0_6.Button(u8("Ñìåíèòü ïîçèöèþ âîïðîñà íà ýêðàíå ")) and var_0_88.active6.v then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Äëÿ ñîõðàíåíèÿ ïîëîæåíèÿ íàæìèòå {ff004d}ÏÐÎÁÅË", 16776960)
			...
			var_0_6.Separator()
			var_0_6.Text(u8("Êîë-âî ñòðîê â îêíå âîïðîñîâ: "))
			var_0_6.SameLine()
			var_0_6.PushItemWidth(120)
			...
			var_0_6.PopItemWidth()
			var_0_6.Text(u8("Ðàçìåð òåêñòà â îêíå âîïðîñîâ: "))
			var_0_6.SameLine()
			var_0_6.PushItemWidth(120)
			...
			var_0_6.PopItemWidth()
			var_0_6.Text(u8("Îêíî ñ âîïðîñàìè"))
			var_0_6.SameLine()
			...
			if var_0_6.Button(u8("Ñìåíèòü ïîçèöèþ îêíà ñ âîïðîñàìè")) and var_0_88.active5.v then
				sampAddChatMessage(var_0_13 .. " {FFFFFF}Äëÿ ñîõðàíåíèÿ ïîëîæåíèÿ íàæìèòå {ff004d}ÏÐÎÁÅË", 16776960)
	...
	if var_0_88.imgui_active4.v then
		...
		var_0_6.SetNextWindowPos(var_0_6.ImVec2(var_0_71 / 2, var_0_72 / 2), var_0_6.Cond.FirstUseEver, var_0_6.ImVec2(0.5, 0.5))
		var_0_6.Begin(var_0_11.ICON_CALENDAR_MINUS_O .. u8(" Support Helper - Ñ÷åò÷èê îíëàéíà"), var_0_88.imgui_active4, var_0_6.WindowFlags.NoResize + var_0_6.WindowFlags.NoCollapse + var_0_6.WindowFlags.NoMove)
		var_0_6.SameLine()
		var_0_6.TextDisabled(u8("Íàâåäèñü êóðñîðîì íà äàííûé òåêñò - F.A.Q ïî ñ÷åò÷èêó"))

		if var_0_6.IsItemHovered() then
			var_0_6.BeginTooltip()
			var_0_6.TextUnformatted(u8("Âðåìÿ â AFK íå ó÷èòûâàåòñÿ\nÎòîáðàæåíèå âðåìåíè îíëàéíà èäåò áåç ó÷åòà ïðîâåäåííîãî âðåìåíè â AFK"))
			var_0_6.EndTooltip()
		end
		...
		if sampGetGamestate() ~= 3 then
			var_0_6.TextColoredRGB(u8("Ïîäêëþ÷åíèå: ") .. get_clock(connectingTime))
		else
			var_0_6.TextColoredRGB(u8("Îíëàéí çà ñåññèþ: ") .. get_clock(var_0_88.sesOnline.v))
			var_0_6.TextColoredRGB(u8("Îíëàéí çà äåíü: ") .. get_clock(var_0_76.onDay.online))
			var_0_6.Separator()
			var_0_6.TextColoredRGB(u8("{0087FF}Îíëàéí çà íåäåëþ: ") .. u8(get_clock(var_0_76.onWeek.online)), 2)
			var_0_6.NewLine()
	...
	if var_0_88.imgui_active5.v then
		...
		var_0_6.Begin(var_0_11.ICON_FILE_TEXT_O .. u8(" Êîìàíäû ñêðèïòà"), var_0_88.imgui_active5, var_0_6.WindowFlags.NoResize + var_0_6.WindowFlags.NoCollapse)

		if var_0_6.CollapsingHeader(u8("/shelper")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Çàïóñòèòü ãëàâíîå ìåíþ ñêðèïòà"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /shelper"))
		end

		if var_0_6.CollapsingHeader(u8("/asupotv")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Çàïóñòèòü ìåíþ ñ÷åò÷èêà îòâåòîâ"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /shelpv"))
		end

		if var_0_6.CollapsingHeader(u8("/pmset")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Çàïóñòèòü ìåíþ íàñòðîéêè áûñòðûõ îòâåòîâ"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /pmset"))
		end

		if var_0_6.CollapsingHeader(u8("/pm [id]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò ñäåëàòü áûñòðûé îòâåò"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /pm [id] è æìåòå êíîïêó 'Enter'"))
		end

		if var_0_6.CollapsingHeader(u8("/hcost [ID äîìà] [ID ÷åëîâåêà]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò âûâåñòè èíôîðìàöèþ î äîìå â /pm"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /hcost [ID äîìà] [ID ÷åëîâåêà]"))
		end

		if var_0_6.CollapsingHeader(u8("/car [ID] [Íàçâàíèå àâòî] [1 - åñëè íóæíî óêàçàòü öåíó ñî ñêèäêîé]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò âûâåñòè èíôîðìàöèþ î ìàøèíå â PM\nÏðèìåð èñïîëüçîâàíèÿ êîìàíäû: /car 23 nrg"))
			var_0_6.Text("")
			var_0_6.Text(u8("Åñëè æå âàì íàäî óêàçàòü öåíó àâòî ñî ñêèäêîé, òî\nÏðèìåð èñïîëüçîâàíèÿ êîìàíäû: /car 23 nrg 1"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}:\n/car [ID] [Íàçâàíèå àâòî] [1 - åñëè íóæíî óêàçàòü öåíó ñî ñêèäêîé]"))
		end

		if var_0_6.CollapsingHeader(u8("/sleaders [ID] [Íàçâàíèå îðãàíèçàöèè]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò ñäåëàòü áûñòðûé ïîèñê ïî ëèäåðàì\nÈ äàëåå âûâåñòè èíôîðìàöèþ â /pm\nÌîæíî ïèñàòü ÷àñòü íàçâàíèÿ îðãàíèçàöèè\nÏðèìåð èñïîëüçîâàíèÿ êîìàíäû: /sleaders 12 grov"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /sleaders [ID] [Íàçâàíèå îðãàíèçàöèè]"))
		end

		if var_0_6.CollapsingHeader(u8("/sfarm [ID]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò âûâåñòè èíôîðìàöèþ î ôåðìàõ â /pm"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /sfarm [ID]"))
		end

		if var_0_6.CollapsingHeader(u8("/skaz [ID]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò âûâåñòè èíôîðìàöèþ ÷üå êàçèíî â /pm"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /skaz [ID]"))
		end

		if var_0_6.CollapsingHeader(u8("/sgps [ID] [Íàçâàíèå gps]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò âûâåñòè èíôîðìàöèþ î /gps â /pm"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /sgps [ID] [Íàçâàíèå gps]"))
		end

		if var_0_6.CollapsingHeader(u8("/skinid [ID] [ID ñêèíà]")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Ïîçâîëÿåò âûâåñòè èíôîðìàöèþ î ñêèíàõ â /pm"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /skinid [ID] [ID ñêèíà]"))
		end

		if var_0_6.CollapsingHeader(u8("/lasup")) then
			var_0_6.TextColoredRGB(u8("{FFE4B5}Îïèñàíèå{FFFFFF}: Îáíîâëåíèå ñ÷åò÷èêà èíôîðìàöèè íà ýêðàíå\nÂî âðåìÿ îáíîâëåíèÿ èíôîðìàöèè,\nèãðà ìîæåò çàâèñíóòü íà 3 - 15 ñåêóíä"))
			var_0_6.Text("")
			var_0_6.TextColoredRGB(u8("{FFE4B5}Èñïîëüçîâàíèå{FFFFFF}: /lasup"))
		end
	...
	if var_0_88.window_12.v then
		...
		if #var_0_65 ~= 0 then
			...
			var_0_6.Text(u8("Íè÷åãî íå íàéäåíî"))
		end
...
function get_clock(arg_71_0)
	...
	return os.date((onDay and math.floor(arg_71_0 / 86400) .. "ä " or "") .. "%H:%M:%S", arg_71_0 + var_71_0)
end
...
function onScriptTerminate(arg_73_0, arg_73_1)
	if arg_73_0 == thisScript() and not restart and var_0_1.save(var_0_76, "Support Helper\\SH-settings.ini") then
		sampfuncsLog("{FFFF00}[Support Helper]: {FFFFFF}Âàø îíëàéí ñîõðàí¸í!")
	end
end
